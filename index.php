...
<header class="hero-unit clearfix">
   ...
   <div class="hero-content">
    ...
    <h1 class="hidden-xs">Felix Ingenium</h1> 
    <h3 class="visible-xs">Felix Ingenium</h3> 
    <h4>There is nothing divine in the vast emptiness ...</h4>


    <p class="intro-poem">
    <span class="intro-poem-icon"><i class="fa fa-pagelines"></i></span>

      Heavy clouds filled the sky <br>
      Beyond the horizon <br>
      She saw a hint of the dawn <br>
      Then she heard the whisper <br>
      Wake up! <br>
      Graceful silence <br>
      Purple breeze <br>
      One moment <br>
